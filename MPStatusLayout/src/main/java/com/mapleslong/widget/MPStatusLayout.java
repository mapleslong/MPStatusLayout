...
public class MPStatusLayout extends FrameLayout {
    ...
    private void initViews() {
        ...
        tvBtnErrorReload.setWidth((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, textReloadWidth, mContext.getResources()
                .getDisplayMetrics()));
        tvBtnErrorReload.setHeight((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, textReloadHeight, mContext.getResources()
                .getDisplayMetrics()));
        ...
        tvBtnNoNetwork.setWidth((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, textReloadWidth, mContext.getResources()
                .getDisplayMetrics()));
        tvBtnNoNetwork.setHeight((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, textReloadHeight, mContext.getResources()
                .getDisplayMetrics()));
        tvBtnNoNetwork.setText(strReload);
